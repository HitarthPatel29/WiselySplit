        ...
        <div className="space-y-4">
          {invites.map((invite) => {
            ...
            return (
              <div
                key={invite.InviteID}
                className={`flex flex-col sm:flex-row sm:items-start gap-4 p-4 rounded-xl bg-white shadow-sm hover:shadow-md transition-all duration-500 ${
              ...
              >
                ...
                <div className="flex flex-col flex-grow text-center sm:text-left">
                  <p className="font-medium text-gray-900">{displayMsg}</p>
