package ca.mohawk_college.wiselysplit_server.services.entry;
...
public class ExpensesService {
    ...
    private void sendClassifierFeedback(Map<String, Object> payload, String title, String finalCategory, Long userId) {
        try {
            ...
            Object entryKind = payload.get("entryKind");
            if (entryKind != null && !"expense".equalsIgnoreCase(entryKind.toString())) return;

            String predicted = (String) payload.get("predictedCategory");
